...
namespace BSIT3L_Movies.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController()
        {
            ...
            new MovieViewModel { Id = 8, Name = "Fast Furious 7", Rating = "5", ReleaseYear = 2015, Genre = "Action/Thriller", ytid="Skpu5HaVkOc",
                   ImageUrl="https://drive.google.com/uc?id=15QhwRDiLv0k35ORrcyrkbtvAajeJLsPv" },
            new MovieViewModel { Id = 9, Name = "Now You See Me 2", Rating = "5", ReleaseYear = 2016, Genre = "Adventure/Crime", ytid="4I8rVcSQbic",
                   ImageUrl="https://drive.google.com/uc?id=1Uoac73rgjIUusEZy71XMshYJrZVMF_bh" },
            new MovieViewModel { Id = 10, Name ="Avengers: Endgame", Rating = "5", ReleaseYear = 2019, Genre = "Action/Sci-fi", ytid="TcMBFSGVi1c",
                   ImageUrl="https://drive.google.com/uc?id=1ZocPmteyx5Oa7TcO8xpWRaOx38Vs31Hv" },
            new MovieViewModel { Id = 11, Name = "Retribution", Rating = "3", ReleaseYear = 2023, Genre = "Action/Thriller", ytid="jzQn0-WH4WM",
                   ImageUrl="https://drive.google.com/uc?id=1pJT9rVlIkWb7f9wBFVXDjrQG1y0qopAf" },
            new MovieViewModel { Id = 12, Name = "I Want to Eat Your Pancreas", Rating = "5", ReleaseYear = 2018, Genre = "Drama/Romance", ytid="MmoBvmJA9XI",
